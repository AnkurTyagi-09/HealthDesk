...
function SpecialityMenu() {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
      <h1 className='text-3xl font-medium '>Specialist Categories</h1>
      <p className='sm:w-1/3 text-center text-sm'>Find the right doctor from our trusted list and book in just a few clicks.</p>
